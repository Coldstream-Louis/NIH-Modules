# Project Description
This project use the UI template of Material Kit with React.js. If you want to run it, clone this repo to your local machine and run `npm install` or `yarn install`. After installation, then run `npm start`, the page will on http://localhost:3000. You can go to http://localhost:3000/Module1 to see the developing page of module 1. 

The following part are the introduction read-me of the template. 
